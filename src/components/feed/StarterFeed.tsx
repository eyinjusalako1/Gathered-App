...
const STARTER_POSTS: FaithPost[] = [
  ...
  },
  {
    ...
    author_avatar_url: null,
    post_type: 'testimony',
    content: "God came through in the most unexpected way today. I'd been praying about a situation for months — and this morning it just resolved. Never stop trusting Him. ✨",
    visibility: 'public',
